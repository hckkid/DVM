...
Module Type IEVALTYPE.
  Parameter n : nat.
  Parameter DVMState : Type.
  Parameter Val : Type.
...
Module IEVAL <: IEVALTYPE.

Parameter n : nat.

Declare Module IDvmStateMod : IDvmStateType with Definition n := n.
Export IDvmStateMod.

Definition DVMState : Type := State.
Definition Val := Val'.
Definition arrOrObj := arrOrObj'.
